      ...
      <div class="col-sm-3">
        <div class="card">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text">Dinner Date - Rs 7999</p>
            <p class="card-text">Full Night/Day - Rs 26000</p>
      ...
      <div class="col-lg-8">
        <form action="{{ route('enquiry') }}" method="POST" role="form" class="php-email-form">
          <div class="row">
            ...
            <div class="col-md-6 form-group">
              <input type="text" name="city" class="form-control" id="city" placeholder="Preference City">
            </div>
            <div class="col-md-6 form-group">
